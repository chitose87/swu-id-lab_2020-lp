<template>
  <div>
    <div class="container">
      <h1 class="block">ヤバイホームページ屋さん</h1>
      <div class="hoge">
    ...
    <div class="container">
      <div class="container1">
        <div class="section">
          ...
          <div class="info">
            <a href="#">2019/04/01 プレスリリース 新サービス発表会について</a>
            <br />
            <a href="#">2019/04/01 メディア掲載 〇〇新聞に掲載されました</a>
            <br />
            <a href="#">2019/04/01 採用情報 2020年度新卒採用を開始いたします</a>
          </div>
